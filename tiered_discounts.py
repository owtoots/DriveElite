...
def render_admin_discount_table(conn):
    ...
    with st.container(border=True):
        ...
        with col1:
           new_r_markup = st.number_input("Renter Platform Fee (%)", min_value=0.0, max_value=100.0, value=current_renter_markup * 100, step=1.0, help="E.g., 10%", key="admin_renter_fee_input_unique")
